      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-white dark:bg-[#150a29] rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-purple-800/50 flex flex-col items-center text-center">
            ...
            <h2 className="text-lg font-bold text-[#2e1065] dark:text-purple-100">สมชาย ใจดี</h2>
            <p className="text-sm text-slate-500 dark:text-purple-200/70 font-medium mb-6">นักวิชาการประมงปฏิบัติการ</p>
        ...
        {/* Right Column: Mock Personal Info Form */}
        <div className="md:col-span-2">
          <div className="bg-white dark:bg-[#150a29] rounded-3xl p-6 md:p-8 shadow-sm border border-slate-100 dark:border-purple-800/50 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700 dark:text-purple-200">อีเมล</label>
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <div className="h-11 px-4 bg-slate-50 dark:bg-[#1a0b2e] border border-slate-200 dark:border-purple-900/50 rounded-xl flex items-center text-slate-700 dark:text-slate-300 font-medium gap-2">
                  ...
                  นักวิชาการประมงปฏิบัติการ - กองวิจัยและพัฒนาวิชาการประมง
                </div>
              </div>
            </div>

            <div className="pt-6">
              <button className="bg-[#4c1d95] hover:bg-[#5b21b6] text-white font-bold py-3 px-6 rounded-xl transition-colors w-full sm:w-auto shadow-md">
                บันทึกการเปลี่ยนแปลง (Mock)
              </button>
            </div>
          </div>
        </div>
